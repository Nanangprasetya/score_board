...
class _ToggleSwitchState extends State<AppToggleSwitch>
    with AutomaticKeepAliveClientMixin<AppToggleSwitch> {
  /// Active background color
              ...
              if (index % 2 == 1) {
                ...
                var icon =
                    widget.icons != null && widget.icons[index ~/ 2] != null
                        ? Container(
                            child: widget.icons[index ~/ 2],
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                            ),
                            width: widget.iconSize >
                                    (_calculateWidth(widget.minWidth) / 2)
                                ? (_calculateWidth(widget.minWidth)) / 2
                                : widget.iconSize,
                        ...
                        Flexible(
                          child: Container(
                            padding: EdgeInsets.only(
                                left: (icon is Container) ? 0.0 : 0.0),
                            child: Text(
